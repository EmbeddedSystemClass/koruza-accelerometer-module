...
//    Serial.println("v2");
    ...
    average_0_x = average(ax_in, RANGE_0);
    average_1_x = average(ax_in, RANGE_1);
    average_2_x = average(ax_in, RANGE_2);
    average_3_x = average(ax_in, RANGE_3);
  
    max_0_x = max_value(ax_in, RANGE_0);
    max_1_x = max_value(ax_in, RANGE_1);
    max_2_x = max_value(ax_in, RANGE_2);
    max_3_x = max_value(ax_in, RANGE_3);
  
    average_0_y = average(ay_in, RANGE_0);
    average_1_y = average(ay_in, RANGE_1);
    average_2_y = average(ay_in, RANGE_2);
    average_3_y = average(ay_in, RANGE_3);
  
    max_0_y = max_value(ay_in, RANGE_0);
    max_1_y = max_value(ay_in, RANGE_1);
    max_2_y = max_value(ay_in, RANGE_2);
    max_3_y = max_value(ay_in, RANGE_3);
  
    average_0_z = average(az_in, RANGE_0);
    average_1_z = average(az_in, RANGE_1);
    average_2_z = average(az_in, RANGE_2);
    average_3_z = average(az_in, RANGE_3);
  
    max_0_z = max_value(az_in, RANGE_0);
    max_1_z = max_value(az_in, RANGE_1);
    max_2_z = max_value(az_in, RANGE_2);
    max_3_z = max_value(az_in, RANGE_3);
...
int searchNearest(double anArray[],double key){
    double value = abs(key - anArray[0]);
    double num = anArray[0]; 
    int num_el = 0;
